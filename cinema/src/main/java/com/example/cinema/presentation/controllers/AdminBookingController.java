...
public class AdminBookingController {
    ...
    private final com.example.cinema.application.usecases.BookingUseCase bookingUseCase;

    public AdminBookingController(BookingQueryUseCase bookingQueryUseCase, com.example.cinema.application.usecases.BookingUseCase bookingUseCase) {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_STAFF')")
    @PostMapping("/direct")
    public ResponseEntity<com.example.cinema.application.dto.BookingResponse> createDirectBooking(
            @RequestBody com.example.cinema.application.dto.CreateBookingRequest request,
