...
import com.example.cinema.infrastructure.database.repositories.SpringDataPermissionRepository;
...
@Component
public class PostgresPermissionAdapter implements PermissionRepositoryPort {
