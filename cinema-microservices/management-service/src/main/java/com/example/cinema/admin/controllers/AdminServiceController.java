...
import com.example.cinema.admin.dto.AdminServiceDTO;
import com.example.cinema.admin.entities.Service;
import com.example.cinema.admin.repositories.ServiceRepository;
...
public class AdminServiceController {
    ...
    public ResponseEntity<List<AdminServiceDTO>> getAllServices() {
        ...
        List<Service> entities = serviceRepository.findAll(Sort.by(Sort.Direction.ASC, "displayOrder"));
    ...
    private AdminServiceDTO mapToDTO(Service entity) {
