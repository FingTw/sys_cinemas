...
import com.example.cinema.admin.services.AdminFacilityUseCaseImpl;
import com.example.cinema.admin.dto.RoomDTO;
import com.example.cinema.admin.dto.SeatDTO;
import com.example.cinema.admin.dto.CreateRoomRequest;
...
public class AdminFacilityController {
    ...
    private final AdminFacilityUseCaseImpl adminFacilityUseCase;
    ...
    @PreAuthorize("hasAuthority('FACILITY_CREATE') and @cinemaSecurityValidator.hasAccessToCinema(authentication, #request.cinemaId)")
    @PostMapping("/rooms")
    ...
    @PreAuthorize("hasAuthority('FACILITY_DELETE') and @cinemaSecurityValidator.hasAccessToRoom(authentication, #id)")
