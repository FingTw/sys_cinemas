...
import com.example.cinema.admin.services.AdminShowtimeUseCaseImpl;
...
public class AdminShowtimeController {
    ...
    private final AdminShowtimeUseCaseImpl adminShowtimeUseCase;
    ...
    @PreAuthorize("hasAuthority('SHOWTIME_CREATE') and @cinemaSecurityValidator.hasAccessToRoom(authentication, #request.roomId)")
    @PostMapping
    ...
    @PreAuthorize("hasAuthority('SHOWTIME_UPDATE') and @cinemaSecurityValidator.hasAccessToShowtime(authentication, #id)")
    ...
    @PreAuthorize("hasAuthority('SHOWTIME_DELETE') and @cinemaSecurityValidator.hasAccessToShowtime(authentication, #id)")
    @DeleteMapping("/{id}")
