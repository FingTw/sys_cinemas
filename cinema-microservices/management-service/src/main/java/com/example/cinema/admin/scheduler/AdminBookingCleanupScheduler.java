package com.example.cinema.admin.scheduler;

import com.example.cinema.admin.entities.Booking;
import com.example.cinema.admin.repositories.BookingRepository;
...
public class AdminBookingCleanupScheduler {
    ...
    public AdminBookingCleanupScheduler(BookingRepository bookingRepository) {
