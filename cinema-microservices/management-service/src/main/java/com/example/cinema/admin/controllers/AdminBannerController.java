...
import com.example.cinema.admin.dto.AdminBannerDTO;
import com.example.cinema.admin.entities.Banner;
import com.example.cinema.admin.repositories.BannerRepository;
...
public class AdminBannerController {
    ...
    public ResponseEntity<List<AdminBannerDTO>> getAllBanners() {
        ...
        List<Banner> entities = bannerRepository.findAllByOrderByDisplayOrderAsc();
    ...
    public ResponseEntity<?> addBanner(@RequestBody AdminBannerDTO requestDto) {
        ...
        List<Banner> all = bannerRepository.findAllByOrderByDisplayOrderAsc();
    ...
    public ResponseEntity<?> reorderBanners(@RequestBody List<String> orderedIds) {
        ...
        List<Banner> entities = bannerRepository.findAll();
    ...
    private AdminBannerDTO mapToDTO(Banner entity) {
