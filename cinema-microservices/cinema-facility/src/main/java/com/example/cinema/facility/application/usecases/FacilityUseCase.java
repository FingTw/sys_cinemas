...
public class FacilityUseCase {
    ...
    public RoomDTO getRoomById(String roomId) {
        ...
        try {
            Room room = roomRepository.findById(roomId)
                    .orElseThrow(() -> new ClientException("Phong chieu khong ton tai"));
            ...
            log.error("Loi CSDL khi truy van phong [{}]: {}", roomId, e.getMessage(), e);
            throw new ServerException("Loi he thong khi truy xuat phong: " + e.getMessage(), e);
        }
    }
    ...
    public SeatDTO getSeatById(String seatId) {
        ...
        try {
            ...
            log.error("Loi CSDL khi truy van ghe [{}]: {}", seatId, e.getMessage(), e);
            throw new ServerException("Loi he thong khi truy xuat ghe: " + e.getMessage(), e);
        }
    }
