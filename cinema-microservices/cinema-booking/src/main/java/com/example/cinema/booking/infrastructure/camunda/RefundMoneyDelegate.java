...
public class RefundMoneyDelegate implements JavaDelegate {
    ...
    private final com.example.cinema.booking.domain.repositories.BookingRepository bookingRepository;
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        try {
            java.util.Optional<com.example.cinema.booking.domain.entities.Booking> bookingOpt = bookingRepository.findById(ticketId);
