...
import com.example.cinema.admin.application.dto.AdminPromotionDTO;
import com.example.cinema.admin.infrastructure.database.entities.PromotionJpaEntity;
import com.example.cinema.admin.infrastructure.database.repositories.SpringDataPromotionRepository;
...
public class AdminPromotionController {
    ...
    public ResponseEntity<List<AdminPromotionDTO>> getAllPromotions() {
        ...
        List<PromotionJpaEntity> entities = promotionRepository.findAll(Sort.by(Sort.Direction.ASC, "displayOrder"));
    ...
    public ResponseEntity<AdminPromotionDTO> createPromotion(@RequestBody AdminPromotionDTO dto) {
        ...
        PromotionJpaEntity entity = PromotionJpaEntity.builder()
                .title(dto.getTitle())
        ...
        PromotionJpaEntity saved = promotionRepository.save(entity);
    ...
    private AdminPromotionDTO mapToDTO(PromotionJpaEntity entity) {
