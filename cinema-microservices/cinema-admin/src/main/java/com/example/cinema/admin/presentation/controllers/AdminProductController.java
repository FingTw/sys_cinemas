...
import com.example.cinema.admin.application.dto.AdminProductDTO;
...
import com.example.cinema.admin.infrastructure.database.repositories.SpringDataProductCategoryRepository;
import com.example.cinema.admin.infrastructure.database.repositories.SpringDataProductRepository;
...
public class AdminProductController {
    ...
    public ResponseEntity<List<AdminProductDTO>> getAllProducts() {
        ...
        List<ProductJpaEntity> entities = productRepository.findAllByIsDeletedFalse(Sort.by(Sort.Direction.ASC, "displayOrder"));
    ...
    public ResponseEntity<AdminProductDTO> createProduct(@RequestBody AdminProductDTO dto) {
        ...
        ProductCategoryJpaEntity category = categoryRepository.findById(dto.getCategoryId())
    ...
    private AdminProductDTO mapToDTO(ProductJpaEntity entity) {
