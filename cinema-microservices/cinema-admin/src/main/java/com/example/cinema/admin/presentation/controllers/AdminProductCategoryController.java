...
import com.example.cinema.admin.application.dto.AdminProductCategoryDTO;
...
public class AdminProductCategoryController {
    ...
    public ResponseEntity<List<AdminProductCategoryDTO>> getAllCategories() {
        ...
        List<ProductCategoryJpaEntity> entities = categoryRepository.findAll(Sort.by(Sort.Direction.ASC, "displayOrder"));
    ...
    private AdminProductCategoryDTO mapToDTO(ProductCategoryJpaEntity entity) {
